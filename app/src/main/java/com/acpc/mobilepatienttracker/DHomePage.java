...
public class DHomePage extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        testbutton.setOnClickListener(new View.OnClickListener() { //what happens when you click the register button
            @Override
            public void onClick(View v) {
                Toast.makeText(getContext(), "You have successfully proceeded", Toast.LENGTH_LONG).show();
                Intent start = new Intent( getContext(), DoctorConsultForm.class); //moving from main screen to reg screen when clicking register button on main screen
                startActivity(start);
            }
        });
